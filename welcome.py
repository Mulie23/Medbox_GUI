...
refill = PushButton(quantity_box1, command=open_window4, text="Refill Medicine",width=15,align="left",height=2)
refill.bg=(135,206,250)
refill.text_size=50
blank_text6=Text(quantity_box1,text="",align="left",width=70)
quit_med_button = PushButton(quantity_box1, command=open_window2, text="Quit Medicine"  ,width="fill",align="left",height=2)
