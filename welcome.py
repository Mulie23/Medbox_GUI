    ...
    if file_exist_time:
        ...
        for i in next_list:
            ...
            if i > 0:
                timer_start_time = i
                break
        timer = threading.Timer(60, dispense_all)
        timer.start()
...
blank_text5=Text(menu_window,text="",width="fill",height=8)
...
refill.text_size=50
blank_text6=Text(menu_box1,text="",align="left",width=38)
...
blank_text8=Text(menu_box2,text="",align="left",width=38)
