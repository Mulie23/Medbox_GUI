...
check_pre_window.hide()
refill_window = Window(app, title="Refill Window",bg = (255,255,224))
...
refill = PushButton(menu_box2, command=open_window4, text="Refill Medicine",width="fill",align="left",height=2)
