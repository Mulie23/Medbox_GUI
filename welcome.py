...
blank_text24=Text(time_box1,text="",align="left",width=8)
morn_text = Text(time_box1, text="Morning:",size=40,align="left")
blank_text210=Text(time_box1,text="",align="left",width=8)
noon_text = Text(time_box1, text="Noon:",size=40,align="left")
blank_text26=Text(time_box1,text="",align="left",width=8)
