...
blank_text24=Text(time_box1,text="",align="left",width=21)
morn_text = Text(time_box1, text="Morning:",size=40,align="left")
blank_text210=Text(time_box1,text="",align="left",width=21)
noon_text = Text(time_box1, text="Noon:",size=40,align="left")
blank_text26=Text(time_box1,text="",align="left",width=21)
after_text = Text(time_box1, text="Afternoon:",size=40,align="left")
blank_text27=Text(time_box1,text="",align="left",width=21)
even_text = Text(time_box1, text="Evening:",size=40,align="left")
blank_text28=Text(time_box1,text="",align="left",width=21)
