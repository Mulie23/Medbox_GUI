...
minus_ten_btn = PushButton(quantity_box, text ="-10", command=minus_ten,align="left",width=10)
minus_ten_btn.text_size=30
blank_text_n1=Text(quantity_box,text="",width=10)
minus_five_btn = PushButton(quantity_box, text ="-5", command=minus_five,align="left",width=10)
minus_five_btn.text_size=30
blank_text_n1=Text(quantity_box,text="",width=10)
minus_one_btn = PushButton(quantity_box, text ="-1", command=minus_one,align="left",width=10)
minus_one_btn.text_size=30
blank_text_n1=Text(quantity_box,text="",width=10)
quantity_no = Text(quantity_box,text="0",align="left",size=30)
blank_text_n1=Text(quantity_box,text="",width=10)
add_one_btn = PushButton(quantity_box, text ="+1", command=add_one,align="left",width=10)
add_one_btn.text_size=30
blank_text_n1=Text(quantity_box,text="",width=10)
add_five_btn = PushButton(quantity_box, text ="+5", command=add_five,align="left",width=10)
add_five_btn.text_size=30
blank_text_n1=Text(quantity_box,text="",width=10)
add_ten_btn = PushButton(quantity_box, text ="+10", command=add_ten,align="left",width=10)
